...
public class EstudianteDiseno extends Estudiante {
    ...
    public List<EstudianteDiseno> solicitarInfoEstudiantes() {
    ...
    public String resgistrarPrestamoDis()
    {
    ...
    public String mostrarTodosLosPrestamosDis() {
        ...
        return "Seleccione para volver al menú principal";
    }
